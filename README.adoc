...
This project shows a minimal fulcro app for demonstration purposes.

== How to get started

You can start how many components of the project you like. When you just want to play with components in CLJS without the backend I recommend to only start the workspaces compiler.
...
You can find the `npm run` script in package.json.
